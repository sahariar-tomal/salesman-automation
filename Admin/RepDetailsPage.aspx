<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RepDetailsPage.aspx.cs" Inherits="RepDetailsPage" Debug="true"%>
            ...
            <tr>
                <td colspan="3">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM &quot;REP_4&quot; WHERE (&quot;RID&quot; = :RID)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="Label1" Name="RID" PropertyName="Text" 
                                Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
